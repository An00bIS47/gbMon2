...
int main(int argc, char *argv[]) {
	...
	mdnsd_set_hostname(svr, hostname, inet_addr("192.168.178.163"));
	
	struct rr_entry *a2_e = NULL;
	a2_e = rr_create_a(create_nlabel(hostname), inet_addr("192.168.178.163"));
	...
	struct mdns_service *svc = mdnsd_register_svc(svr, "gbMon2",
												  "_cocoaecho._tcp.local", 1000, NULL, txt);
